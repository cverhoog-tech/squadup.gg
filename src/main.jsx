...
function ImmersiveExplore({games,wishlist,toggleWish,setSelected}){
 ...
 const endlessBlocks=[
  {type:'double', a:'Play Your Way', b:'Trending With Friends', start:0},
  {type:'split', title:'Live Events', mode:'spotlight-left', start:4},
  {type:'compact', title:'Popular Categories', start:5},
  {type:'split', title:'New & Upcoming', mode:'list-left', start:7},
  {type:'double', a:'Editor’s Choice', b:'Beyond The Hype', start:9},
  {type:'split', title:'Curated Collection', mode:'spotlight-left', start:2},
  {type:'compact', title:'Weekend LAN Picks', start:3},
  {type:'split', title:'Community Spotlight', mode:'list-left', start:6},
  {type:'double', a:'Co-op Adventures', b:'Survival Squad Nights', start:1},
  {type:'split', title:'SquadUp Rewards', mode:'spotlight-left', start:8},
  {type:'double', a:'PvP Hotlist', b:'Ranked With Friends', start:10},
  {type:'split', title:'Steam Deals', mode:'list-left', start:11},
  {type:'compact', title:'Under €20 Picks', start:12},
  {type:'split', title:'Hidden Gems', mode:'spotlight-left', start:13},
  {type:'double', a:'Survival Worlds', b:'Base Building Nights', start:14},
  ...
  {type:'split', title:'New Trailers', mode:'list-left', start:19},
  ...
  {type:'split', title:'Build The Backlog', mode:'spotlight-left', start:33},
  {type:'double', a:'Party Ready Games', b:'Voice Chat Recommended', start:34},
