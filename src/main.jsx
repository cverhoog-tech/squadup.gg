...
function ProfilePage({wishlist,toggleWish,setSelected}){
 ...
 const [avatar,setAvatar]=useState(squadAvatarSet[0].url);
 ...
 return <Page><MobileHeader/>
  ...
  {showAvatars&&<div className="avatarModal">
    <div className="avatarModalCard">
      <div className="avatarModalHead"><div><p className="accent">SquadUp Avatar Vault</p><h2>Choose Your Operator</h2><small>First set: 150 gritty neon squad avatars</small></div><button onClick={()=>setShowAvatars(false)}><X size={18}/></button></div>
